/**************************************************************************************************************
 * Copied from : https://lkmidas.github.io/posts/20210128-linux-kernel-pwn-part-2/smep_fullchain.c
 * Just backup for reference(How to return from kernelspace to userspace: swapgs, iretq, manipulate stack).
 **************************************************************************************************************/
